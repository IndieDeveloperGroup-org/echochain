...
// end include: preamble.js
  ...
  function _JS_NotifyUnityReady() {
          if (typeof window.onUnityReady === "function") {
              window.onUnityReady();
          } else {
              console.warn("[AuthBridge.jslib] window.onUnityReady is not defined.");
          }
      }
  ...
  function _JS_SendAuthStatus(statusPtr) {
          var status = UTF8ToString(statusPtr);
          if (typeof window.onUnityAuthStatus === "function") {
              window.onUnityAuthStatus(status);
          } else {
              console.warn("[AuthBridge.jslib] window.onUnityAuthStatus is not defined. Status: " + status);
          }
      }
  ...
  function _SpeakWeb(strPointer, languageCodeStrPtr) 
  	{		
...
var wasmImports = {
  "CancelSpeakWeb": _CancelSpeakWeb,
  "GetJSLoadTimeInfo": _GetJSLoadTimeInfo,
  "GetJSMemoryInfo": _GetJSMemoryInfo,
  "IsSpeakingWeb": _IsSpeakingWeb,
  ...
  "JS_NotifyUnityReady": _JS_NotifyUnityReady,
  ...
  "JS_SendAuthStatus": _JS_SendAuthStatus,
